...
function UserPage() {
  ...
  const xVoltTransfered =
    barData?.user?.xVoltIn > barData?.user?.xVoltOut
      ...
      : parseFloat(barData?.user?.VoltOut) - parseFloat(barData?.user?.xVoltIn);
  ...
  return (
    <AppShell>
      <Head>
        <title>User {id} | VoltSwap Analytics</title>
      </Head>
              ...
              <Table aria-label="farming">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell key="barRoiVolt" align="right">
                      ROI (All-time)
                    </TableCell>
                  </TableRow>
                </TableHead>
                    ...
                    <TableCell component="th" scope="row">
                      <Box display="flex" alignItems="center">
                        <Avatar
                          ...
                          alt="VOLT"
                          src={`https://raw.githubusercontent.com/voltfinance/token-logos/main/logos/${toChecksumAddress(
                            VOLT_TOKEN_ADDRESS
                          )}/logo.png`}
                        />
                        <Link
              ...
              <Table aria-label="farming">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell key="pendingVolt" align="right">
                      Volt Pending
                    </TableCell>
                    <TableCell key="voltHarvested" align="right">
                      Volt Harvested
                    </TableCell>
